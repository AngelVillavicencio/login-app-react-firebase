                ...
                <div class="-mx-4 flex flex-wrap">
                  <div class="w-full px-4">
                    ...
                    >
                      ...
                      <div class="mb-8">
                        <Form.Item>
                          <input
                            type="submit"
                            value="Ingresar"
                            class="bordder-primary w-full cursor-pointer rounded-md border bg-primary py-3 px-5 text-base text-white transition duration-300 ease-in-out hover:shadow-md bg-blue-600"
                          />
                      ...
                      <a
                        href=""
                        class="mb-2 inline-block text-base text-[#adadad] hover:text-primary hidden"
                      >
                        Forget Password?
                      </a>
 ...
 * 
 * 
 * <p class="mb-6 text-base text-[#adadad]">Conéctate con</p>
